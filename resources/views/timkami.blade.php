...
@section('content')
    <div class="container">
        ...
        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#addPerson"><span
                class="fas fa-plus"></span> Add Person</button>
        <div class="row justify-content-center text-center">
            <!-- LOOP -->
            <div class="col-3 m-3">
                <div class="card h-100" style="width: 250px;">
                    <img src="{{ asset('foto/pp.jpg') }}" class="card-img-top ratio-1x1 rounded-circle mx-auto mt-3"
    ...
    <!-- MODAL -->
    <div class="modal fade" id="addPerson" tabindex="-1" role="dialog" aria-labelledby="addPersonLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="">
                        ...
                        <div class="row m-1 mt-2">
                            ...
                            <div class="col-8">
                                <input type="text" name="github" disabled id="field1" class="form-control"
                        ...
                        <div class="row m-1">
                            ...
                            <div class="col-8">
                                <input type="text" name="facebook" disabled id="field2" class="form-control"
                        ...
                        <div class="row m-1">
                            ...
                            <div class="col-8">
                                <input type="text" name="instagram" disabled id="field3" class="form-control"
                        ...
                        <div class="row m-1">
                            ...
                            <div class="col-8">
                                <input type="text" name="youtube" disabled id="field4" class="form-control"
                        ...
                        <div class="row m-1">
                            ...
                            <div class="col-8">
                                <input type="text" name="twitter" disabled id="field5" class="form-control"
